          ...
          <Table>
            ...
            <TableBody displayRowCheckbox={false}>
              <TableRow>
                ...
                <TableRowColumn>Admin Istrator</TableRowColumn>
                <TableRowColumn>admin@admin.com</TableRowColumn>
                <TableRowColumn><label className="label label-success">Yes</label></TableRowColumn>
                <TableRowColumn>Administrator</TableRowColumn>
                <TableRowColumn>2016-02-18 16:59:34</TableRowColumn>
                <TableRowColumn>2016-02-18 16:59:34</TableRowColumn>
                <TableRowColumn>
...
function mapStateToProps(state, ownProps) {
  ...
  const { route, location: {pathname, query, search} } = ownProps;
  return {
    myId: myProfile.id,
