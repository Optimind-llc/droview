...
<link rel="stylesheet" href="/landing-page/css/font-icon.css">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="person">
          ...
          <ul class="social-icons clearfix">
            ...
            <li><a href="#" class=""><span class="fa fa-github"></span></a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 conForm">
        ...
        <form method="post" action="/contact" name="cform" id="cform">
          ...
          <input type="submit" id="submit" name="send" class="submitBnt" value="送信">
...
<script src="/landing-page/js/jquery.flexslider-min.js"></script> 
<script src="/landing-page/js/retina.min.js"></script> 
<script src="/landing-page/js/modernizr.js"></script> 
<script src="/landing-page/js/main.js"></script> 
<script type="text/javascript" src="/landing-page/js/jquery.contact.js"></script>
</body>
</html>